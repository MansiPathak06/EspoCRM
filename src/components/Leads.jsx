        ...
        {currentView === 'list' ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                <div className="text-lg font-medium text-gray-700 mb-4">Details</div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Opportunity Amount</label>
                  <div className="flex">
                    <input
                      type="number"
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <button className="px-3 py-2 border border-l-0 border-gray-300 bg-gray-50 text-gray-400 hover:text-gray-600">
                      🔍
                    </button>
                    <button className="px-3 py-2 border border-l-0 border-gray-300 rounded-r bg-gray-50 text-gray-400 hover:text-gray-600">
                      <X className="w-4 h-4" />
                    </button>
                  </div>
                </div>
