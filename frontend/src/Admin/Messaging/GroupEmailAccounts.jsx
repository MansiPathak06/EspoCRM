...
import { Plus, ArrowLeft, ArrowRight, X, Info, Calendar, MoreVertical } from 'lucide-react';

const GroupEmailAccounts = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    teams: '',
    groupEmailFolder: '',
    forAllTeamUsers: true,
    excludeFromReply: false,
    fetchEmails: true,
    fetchSince: '',
    host: '',
    port: '993',
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-700">Group Email Accounts</span>
            </div>
            <button
          ...
          {activeTab === 'Main' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex">
                  <select
                    value={formData.groupEmailFolder}
                    onChange={(e) => handleInputChange('groupEmailFolder', e.target.value)}
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center space-x-6">
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                      checked={formData.forAllTeamUsers}
                      onChange={(e) => handleInputChange('forAllTeamUsers', e.target.checked)}
                  ...
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                      checked={formData.excludeFromReply}
                      onChange={(e) => handleInputChange('excludeFromReply', e.target.checked)}
                      className="mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <span className="flex items-center text-sm font-medium text-gray-700">
                      Exclude from Reply
              ...
              <div>
                ...
                <div className="flex items-center space-x-6">
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                      checked={formData.createCase}
                      onChange={(e) => handleInputChange('createCase', e.target.checked)}
                      className="mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <span className="flex items-center text-sm font-medium text-gray-700">
                      Create Case
...
export default GroupEmailAccounts;